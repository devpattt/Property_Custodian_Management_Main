...
// Transfer history
$sql1 = "SELECT * FROM bcp_sms4_assign_con_trans_hstry $where ORDER BY reference_no DESC";
$result1 = $conn->query($sql1);
$total_transfer = $result1->num_rows;

// Added history
$sql2 = "SELECT * FROM bcp_sms4_assign_con_add_hstry $where ORDER BY reference_no DESC";
$result2 = $conn->query($sql2);
$total_added = $result2->num_rows;
?>
...
<head>
  ...
  <style>
    ...
    .filter-links a:hover, .filter-links button:hover {
      background: #047f04;
    }
    .hidden-col {
      display: none;
...
<body>
  <div class="container">
    ...
    <div class="card">
      <h2 id="totalRows"><?= $total_transfer ?> Total Rows</h2>
    </div>

    <!-- ✅ Tabs -->
    <div class="tabs">
      <button class="active" onclick="showTab('transfer', this)">Transfer History</button>
      <button onclick="showTab('added', this)">Added History</button>
    </div>
        ...
        <tbody>
          <?php while($row = $result1->fetch_assoc()): ?>
            <tr>
              ...
              <td class="hidden-col"><?= $row['assigned_date'] ?></td>

...
DROP TABLE IF EXISTS `bcp_sms4_audit_findings`;
CREATE TABLE `bcp_sms4_audit_findings` (
  ...
  CONSTRAINT `bcp_sms4_audit_findings_ibfk_1` FOREIGN KEY (`history_id`) REFERENCES `bcp_sms4_audit_history` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

DROP TABLE IF EXISTS `bcp_sms4_audit_history`;
CREATE TABLE `bcp_sms4_audit_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `department_id` (`department_id`),
  CONSTRAINT `bcp_sms4_audit_history_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`)
...
DROP TABLE IF EXISTS `bcp_sms4_custodian_transfers`;
CREATE TABLE `bcp_sms4_custodian_transfers` (
  ...
  KEY `from_teacher_id` (`from_teacher_id`),
  KEY `to_teacher_id` (`to_teacher_id`),
  KEY `transferred_by` (`transferred_by`),
  CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_1` FOREIGN KEY (`issuance_id`) REFERENCES `bcp_sms4_issuance` (`id`),
  CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_2` FOREIGN KEY (`from_teacher_id`) REFERENCES `bcp_sms4_admins` (`id`),
  CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_3` FOREIGN KEY (`to_teacher_id`) REFERENCES `bcp_sms4_admins` (`id`),
  CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_4` FOREIGN KEY (`transferred_by`) REFERENCES `bcp_sms4_admins` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

DROP TABLE IF EXISTS `bcp_sms4_departments`;
...
CREATE TABLE `bcp_sms4_issuance` (
  ...
  KEY `fk_issuance_department` (`department_id`),
  KEY `fk_issuance_asset` (`asset_id`),
  KEY `fk_issuance_consumable` (`consumable_id`),
  KEY `fk_issuance_item` (`item_id`),
  CONSTRAINT `fk_issuance_admin` FOREIGN KEY (`issued_by`) REFERENCES `bcp_sms4_admins` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_issuance_asset` FOREIGN KEY (`asset_id`) REFERENCES `bcp_sms4_asset` (`asset_id`),
  CONSTRAINT `fk_issuance_consumable` FOREIGN KEY (`consumable_id`) REFERENCES `bcp_sms4_consumable` (`id`),
  CONSTRAINT `fk_issuance_department` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`),
  CONSTRAINT `fk_issuance_item` FOREIGN KEY (`item_id`) REFERENCES `bcp_sms4_items` (`item_id`),
...
CREATE TABLE `bcp_sms4_requests` (
  ...
  KEY `asset_id` (`asset_id`),
  KEY `consumable_id` (`consumable_id`),
  KEY `fk_request_department` (`department_id`),
  ...
  CONSTRAINT `fk_request_department` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`)
...
(22, 99, 1, '0013-03-12 00:00:00', '2025-10-01 01:18:24', 'Completed', 'Audit completed by Admin for department 1', '2025-10-01 01:18:24'),
(23, 99, 1, '0013-03-12 00:00:00', '2025-10-01 01:18:31', 'Completed', 'Audit completed by Admin for department 1', '2025-10-01 01:18:31');

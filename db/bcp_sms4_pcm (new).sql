...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2025 at 11:23 AM
...
(2, 'teacher', 'Teacher', 'Teacher', '$2y$10$WHJtGH2A7l3ZEKron3u.WOT6zUR6bGHGhssU0vIWqeo/pm7yUTxma', 'elmersindorodriguez08@gmail.com'),
(3, 'admin', 'Admin', 'Administrator', '$2y$10$nP8qd/wMRvtqHtc.ukF5d.zkDOQK9DJKLo.p4RaP3EgAMezJkwewS', 'elmersindorodriguez08@gmail.com'),
(4, 'teacher', 'Custodian', 'Custodian', '$2y$10$a4y/te38BWq/VZ/hBWsBx.XFaSsuLKZjVnWb9beJcq6nR6CDIkIlO', 'elmersindorodriguez08@gmail.com'),
(5, 'teacher', 'Sherwin', 'Sherwin Juana', '$2y$10$Cwfsq0lljw6hifOemKfZJ.6.UyuPZEzRQ0pME.R8mZ7UDOGxUKr7C', 'user1@gmail.com'),
(6, 'teacher', 'Alex', 'Alexis Sofio Aco', '$2y$10$SPsunt0tpmBCi4bCrxnHPeyArCazZHZUbs0hiTPrckPVaS.HFgPcm', 'user2@gmail.com'),
(7, 'teacher', 'Emm', 'Emm Bruce Junio', '$2y$10$7b.NVzAjeQ9AkKTG6J1AIO2GtC1qUNkyAs/.rxgI7EybPG/iJD0v.', 'user3@gmail.com'),
(8, 'teacher', 'robert', 'Robert Ken Bordamonte', '$2y$10$xM.qkheiw8RsK3spETDfIOXF8Wqe74f4c5KxkBi4ouLk.2zepEema', 'user4@gmail.com'),
(9, 'teacher', 'Cedric', 'John Cedric Magsadia', '$2y$10$YdM8QVAD3SAH2NAdhJJse.4WQbWfr16Mp9btwmFiWpZyI/y.yEWOm', 'user5@gmail.com'),
(10, 'custodian', 'Christian', 'John Christian Vega', '$2y$10$TULFDHYxaHIUrDpTGXLM3OUjO3OF34bGnZ3ioofAOmIe1A4dN0kCS', 'user6@gmail.com'),
(11, 'custodian', 'Paulo', 'John Paulo Arrieta', '$2y$10$PnlcUjJi7LGe/vnti1o48eMIKrLPBbiDeFhJy1ebmc34YZVSRiLYS', 'user7@gmail.com'),
(12, 'custodian', 'rheyvin', 'Rheyvin Galang', '$2y$10$rNStkKVQebhL76fOn2cQCO.W.CYYzvq9hFBk1qyL/awldH1mh2MiS', 'user8@gmail.com'),
(13, 'custodian', 'Vermelle', 'Vermelle James Mendiola', '$2y$10$vkOzMRPZsbJYNS3D4jl3mOFhhXKz5IRhV7yA/Iimn94ObeLXQt3ZW', 'user9@gmail.com'),
(14, 'custodian', 'Aaron', 'Aaron Cristobal', '$2y$10$JC8NCgXG4L8M.z7QS8/ikut2uXT8GNMnKLdIvZuXF3Tk9eIhmWg.e', 'user10@gmail.com');
...
(5, 2, 'ASSET-2025-0001', 'In-Use', NULL, '2', '2025-09-20'),
(6, 2, 'ASSET-2025-0002', 'In-Use', NULL, '2', '2025-09-20'),
(7, 2, 'ASSET-2025-0003', 'In-Use', NULL, '2', '2025-09-20'),
(8, 2, 'ASSET-2025-0004', 'In-Use', NULL, '2', '2025-09-20'),
(9, 2, 'ASSET-2025-0005', 'In-Use', NULL, '2', '2025-09-20'),
(10, 2, 'ASSET-2025-0006', 'In-Use', NULL, '2', '2025-09-20'),
(11, 2, 'ASSET-2025-0007', 'In-Use', NULL, '', '2025-09-20'),
(12, 2, 'ASSET-2025-0008', 'In-Use', NULL, '', '2025-09-20'),
...
(257, 1, 'ASSET-2025-0253', 'In-Use', NULL, NULL, '2025-09-29'),
(258, 1, 'ASSET-2025-0254', 'In-Use', NULL, NULL, '2025-09-29'),
(259, 1, 'ASSET-2025-0255', 'In-Use', NULL, NULL, '2025-09-29'),
(260, 1, 'ASSET-2025-0256', 'In-Use', NULL, NULL, '2025-09-29'),
...
(99, '0013-03-12', 1, 14, 'Completed'),
(100, '2025-10-03', 1, 10, 'Completed');
...
--
-- Dumping data for table `bcp_sms4_audit_discrepancies`
--
...
--
-- Table structure for table `bcp_sms4_audit_findings`
--

CREATE TABLE `bcp_sms4_audit_findings` (
  `id` int(11) NOT NULL,
  `history_id` int(11) NOT NULL,
  `asset_id` int(11) NOT NULL,
  `asset_name` varchar(150) NOT NULL,
  `quantity` int(11) NOT NULL DEFAULT 1,
  `finding_status` enum('Valid','Disposed','Mismatch','Missing','Broken','Repair Needed') DEFAULT 'Valid',
  `asset_condition` enum('Good','Fair','Damaged','Lost') DEFAULT 'Good',
  `remarks` text DEFAULT NULL,
  `recorded_on` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `bcp_sms4_audit_findings`
--
...
(8, 24, 7, 'Student Armchair', 1, 'Mismatch', 'Lost', ';/', '2025-10-01 09:17:44');

-- --------------------------------------------------------

--
-- Table structure for table `bcp_sms4_audit_history`
--
...
--
-- Dumping data for table `bcp_sms4_audit_history`
--

INSERT INTO `bcp_sms4_audit_history` (`id`, `audit_id`, `department_id`, `started_date`, `completed_date`, `status`, `remarks`, `archived_on`) VALUES
(22, 99, 1, '0013-03-12 00:00:00', '2025-10-01 01:18:24', 'Completed', 'Audit completed by Admin for department 1', '2025-09-30 17:18:24'),
(23, 99, 1, '0013-03-12 00:00:00', '2025-10-01 01:18:31', 'Completed', 'Audit completed by Admin for department 1', '2025-09-30 17:18:31'),
(24, 100, 1, '2025-10-03 00:00:00', '2025-10-01 17:17:44', 'Completed', 'Audit completed by Admin for department 1', '2025-10-01 09:17:44');
...
--
-- Table structure for table `bcp_sms4_custodian_transfers`
--

CREATE TABLE `bcp_sms4_custodian_transfers` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bcp_sms4_custodian_transfers`
--

INSERT INTO `bcp_sms4_custodian_transfers` (`id`, `issuance_id`, `from_teacher_id`, `to_teacher_id`, `transfer_date`, `transferred_by`, `remarks`) VALUES
(13, 24, 2, 4, '2025-09-30 14:44:57', 3, 'axfagaga');

-- --------------------------------------------------------

--
-- Table structure for table `bcp_sms4_departments`
--

CREATE TABLE `bcp_sms4_departments` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `bcp_sms4_departments`
--

INSERT INTO `bcp_sms4_departments` (`id`, `dept_code`, `dept_name`) VALUES
...
--
-- Table structure for table `bcp_sms4_issuance`
--
...
--
-- Dumping data for table `bcp_sms4_issuance`
--

INSERT INTO `bcp_sms4_issuance` (`id`, `reference_no`, `request_id`, `item_id`, `asset_id`, `consumable_id`, `category`, `quantity`, `teacher_id`, `department_id`, `issued_by`, `assigned_date`, `end_date`, `remarks`) VALUES
(24, 'ISS-20250930084440-8D1FDA', 27, 2, 7, NULL, 'Asset', 1, 4, 1, 3, '2025-09-30 14:44:40', NULL, NULL);
...
--
-- Table structure for table `bcp_sms4_requests`
--
...
--
-- Dumping data for table `bcp_sms4_requests`
--
...
--
-- Indexes for table `bcp_sms4_audit_findings`
--
ALTER TABLE `bcp_sms4_audit_findings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `history_id` (`history_id`);

--
-- Indexes for table `bcp_sms4_audit_history`
--
ALTER TABLE `bcp_sms4_audit_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `department_id` (`department_id`);
...
--
-- Indexes for table `bcp_sms4_custodian_transfers`
--
ALTER TABLE `bcp_sms4_custodian_transfers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `issuance_id` (`issuance_id`),
  ADD KEY `from_teacher_id` (`from_teacher_id`),
  ADD KEY `to_teacher_id` (`to_teacher_id`),
  ADD KEY `transferred_by` (`transferred_by`);

--
-- Indexes for table `bcp_sms4_departments`
--
ALTER TABLE `bcp_sms4_departments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `dept_code` (`dept_code`);

--
-- Indexes for table `bcp_sms4_issuance`
--
ALTER TABLE `bcp_sms4_issuance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_issuance_request` (`request_id`),
  ADD KEY `fk_issuance_teacher` (`teacher_id`),
  ADD KEY `fk_issuance_admin` (`issued_by`),
  ADD KEY `fk_issuance_department` (`department_id`),
  ADD KEY `fk_issuance_asset` (`asset_id`),
  ADD KEY `fk_issuance_consumable` (`consumable_id`),
  ADD KEY `fk_issuance_item` (`item_id`);
...
--
-- Indexes for table `bcp_sms4_requests`
--
ALTER TABLE `bcp_sms4_requests`
  ADD PRIMARY KEY (`request_id`),
  ADD KEY `teacher_id` (`teacher_id`),
  ADD KEY `asset_id` (`asset_id`),
  ADD KEY `consumable_id` (`consumable_id`),
  ADD KEY `fk_request_department` (`department_id`);
...
--
ALTER TABLE `bcp_sms4_asset`
  MODIFY `asset_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=262;
...
--
-- AUTO_INCREMENT for table `bcp_sms4_audit_findings`
--
ALTER TABLE `bcp_sms4_audit_findings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `bcp_sms4_audit_history`
--
ALTER TABLE `bcp_sms4_audit_history`
...
--
-- AUTO_INCREMENT for table `bcp_sms4_custodian_transfers`
--
ALTER TABLE `bcp_sms4_custodian_transfers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `bcp_sms4_departments`
--
ALTER TABLE `bcp_sms4_departments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `bcp_sms4_issuance`
--
ALTER TABLE `bcp_sms4_issuance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
-- AUTO_INCREMENT for table `bcp_sms4_requests`
--
ALTER TABLE `bcp_sms4_requests`
...
--
-- Constraints for table `bcp_sms4_audit`
--
ALTER TABLE `bcp_sms4_audit`
  ADD CONSTRAINT `bcp_sms4_audit_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`),
  ADD CONSTRAINT `bcp_sms4_audit_ibfk_2` FOREIGN KEY (`custodian_id`) REFERENCES `bcp_sms4_admins` (`id`);

--
-- Constraints for table `bcp_sms4_audit_findings`
--
ALTER TABLE `bcp_sms4_audit_findings`
  ADD CONSTRAINT `bcp_sms4_audit_findings_ibfk_1` FOREIGN KEY (`history_id`) REFERENCES `bcp_sms4_audit_history` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `bcp_sms4_audit_history`
--
ALTER TABLE `bcp_sms4_audit_history`
  ADD CONSTRAINT `bcp_sms4_audit_history_ibfk_1` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`);
...
--
-- Constraints for table `bcp_sms4_custodian_transfers`
--
ALTER TABLE `bcp_sms4_custodian_transfers`
  ADD CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_1` FOREIGN KEY (`issuance_id`) REFERENCES `bcp_sms4_issuance` (`id`),
  ADD CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_2` FOREIGN KEY (`from_teacher_id`) REFERENCES `bcp_sms4_admins` (`id`),
  ADD CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_3` FOREIGN KEY (`to_teacher_id`) REFERENCES `bcp_sms4_admins` (`id`),
  ADD CONSTRAINT `bcp_sms4_custodian_transfers_ibfk_4` FOREIGN KEY (`transferred_by`) REFERENCES `bcp_sms4_admins` (`id`);

--
-- Constraints for table `bcp_sms4_issuance`
--
ALTER TABLE `bcp_sms4_issuance`
  ADD CONSTRAINT `fk_issuance_admin` FOREIGN KEY (`issued_by`) REFERENCES `bcp_sms4_admins` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_issuance_asset` FOREIGN KEY (`asset_id`) REFERENCES `bcp_sms4_asset` (`asset_id`),
  ADD CONSTRAINT `fk_issuance_consumable` FOREIGN KEY (`consumable_id`) REFERENCES `bcp_sms4_consumable` (`id`),
  ADD CONSTRAINT `fk_issuance_department` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`),
  ADD CONSTRAINT `fk_issuance_item` FOREIGN KEY (`item_id`) REFERENCES `bcp_sms4_items` (`item_id`),
  ADD CONSTRAINT `fk_issuance_request` FOREIGN KEY (`request_id`) REFERENCES `bcp_sms4_requests` (`request_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_issuance_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `bcp_sms4_admins` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `bcp_sms4_reports`
  ADD CONSTRAINT `bcp_sms4_reports_ibfk_8` FOREIGN KEY (`assigned_to`) REFERENCES `bcp_sms4_admins` (`id`),
  ADD CONSTRAINT `bcp_sms4_reports_ibfk_9` FOREIGN KEY (`reported_by`) REFERENCES `bcp_sms4_admins` (`id`),
  ADD CONSTRAINT `fk_reports_asset` FOREIGN KEY (`asset_id`) REFERENCES `bcp_sms4_asset` (`asset_id`) ON UPDATE CASCADE;

--
-- Constraints for table `bcp_sms4_requests`
--
ALTER TABLE `bcp_sms4_requests`
  ADD CONSTRAINT `bcp_sms4_requests_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `bcp_sms4_admins` (`id`),
  ADD CONSTRAINT `bcp_sms4_requests_ibfk_2` FOREIGN KEY (`asset_id`) REFERENCES `bcp_sms4_asset` (`asset_id`),
  ADD CONSTRAINT `bcp_sms4_requests_ibfk_3` FOREIGN KEY (`consumable_id`) REFERENCES `bcp_sms4_consumable` (`id`),
  ADD CONSTRAINT `fk_request_department` FOREIGN KEY (`department_id`) REFERENCES `bcp_sms4_departments` (`id`);
COMMIT;

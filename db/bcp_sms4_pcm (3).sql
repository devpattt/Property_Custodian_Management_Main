...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2025 at 12:41 AM
...
(3, '2025-09-30', 'IT', 'Custodian 3', 'Scheduled'),
...
(1, 'Projector - Room 201', 'Lost', 3, 2, '2025-09-16 13:30:04', 'Resolved', 'Projector went missing after class.', NULL),
(2, 'Library Chair - ID123', 'Damaged', 3, 2, '2025-09-16 22:04:23', 'Resolved', 'Chair leg broken, unsafe to use.', 'chair_damage.jpg'),
(3, 'Laptop - SN456', 'Repair/Replacement', 3, NULL, '2025-09-02 16:00:00', 'Resolved', 'Laptop not booting, replaced with new unit.', NULL),
(4, 'Whiteboard Marker Set', 'Lost', 3, NULL, '2025-09-04 16:00:00', 'Rejected', 'Reported lost, later found.', NULL),
(5, 'Projector - Room 201', 'Lost', 3, NULL, '2025-08-31 16:00:00', 'Pending', 'Projector went missing after class.', NULL),
(6, 'Library Chair', 'Damaged', 3, 2, '2025-09-16 13:29:43', 'Pending', 'One leg is broken and unstable.', NULL),
(7, 'Whiteboard Marker Set', 'Lost', 3, 2, '2025-09-16 13:29:43', 'Pending', 'Reported lost, later found.', NULL),
(8, 'Air Conditioner', '', 3, 2, '2025-09-16 13:29:43', 'Pending', 'Not cooling properly, needs replacement.', NULL),
(9, 'Fire Extinguisher', 'Damaged', 3, 2, '2025-09-07 16:00:00', 'Resolved', 'Pressure gauge is broken.', NULL),
(10, 'aw', 'Damaged', 2, 2, '2025-09-15 02:15:06', 'Resolved', 'aa', NULL),
(11, 'aw', 'Lost', 2, 2, '2025-09-15 02:15:10', 'Resolved', 'aw', NULL),
(12, 'Marijuana', 'Repair/Replacement', 2, 2, '2025-09-15 02:15:13', 'Resolved', 'aw', NULL);
...
--
ALTER TABLE `bcp_sms4_asset_audit`
  ADD CONSTRAINT `bcp_sms4_asset_audit_ibfk_1` FOREIGN KEY (`asset_id`) REFERENCES `bcp_sms4_asset` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `bcp_sms4_reports`
  ADD CONSTRAINT `bcp_sms4_reports_ibfk_1` FOREIGN KEY (`assigned_to`) REFERENCES `bcp_sms4_admins` (`id`),
  ADD CONSTRAINT `bcp_sms4_reports_ibfk_7` FOREIGN KEY (`reported_by`) REFERENCES `bcp_sms4_admins` (`id`);
COMMIT;
